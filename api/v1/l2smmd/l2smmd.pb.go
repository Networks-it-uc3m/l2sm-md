...
const file_l2smmd_proto_rawDesc = "" +
	"\n" +
	"\fl2smmd.proto\x12\x06l2smmd\"\xa9\x01\n" +
	"\bProvider\x12\x12\n" +
	...
	"\vrest_config\x18\x02 \x01(\v2\x12.l2smmd.RestConfigR\n" +
	"restConfig\x12)\n" +
	"\aoverlay\x18\x03 \x01(\v2\x0f.l2smmd.OverlayR\aoverlay\x12/\n" +
	"\fgateway_node\x18\x04 \x01(\v2\f.l2smmd.NodeR\vgatewayNode\x12\x1c\n" +
	"\tnamespace\x18\x05 \x01(\tR\tnamespace\x12(\n" +
	"\x10pod_address_pool\x18\x06 \x01(\tR\x0epodAddressPool\"q\n" +
	"\aOverlay\x12,\n" +
	"\bprovider\x18\x01 \x01(\v2\x10.l2smmd.ProviderR\bprovider\x12\x14\n" +
	"\x05nodes\x18\x02 \x03(\tR\x05nodes\x12\"\n" +
	"\x05links\x18\x03 \x03(\v2\f.l2smmd.LinkR\x05links\"\xa9\x01\n" +
	"\tL2Network\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12,\n" +
	"\bprovider\x18\x02 \x01(\v2\x10.l2smmd.ProviderR\bprovider\x12\x19\n" +
	"\bpod_cidr\x18\x03 \x01(\tR\apodCidr\x12\x12\n" +
	"\x04type\x18\x04 \x01(\tR\x04type\x12+\n" +
	"\bclusters\x18\x05 \x03(\v2\x0f.l2smmd.ClusterR\bclusters\"\x86\x01\n" +
	"\x05Slice\x12,\n" +
	"\bprovider\x18\x01 \x01(\v2\x10.l2smmd.ProviderR\bprovider\x12+\n" +
	"\bclusters\x18\x02 \x03(\v2\x0f.l2smmd.ClusterR\bclusters\x12\"\n" +
	"\x05links\x18\x03 \x03(\v2\f.l2smmd.LinkR\x05links\"a\n" +
	"\x14CreateNetworkRequest\x12+\n" +
	"\anetwork\x18\x01 \x01(\v2\x11.l2smmd.L2NetworkR\anetwork\x12\x1c\n" +
	...
	"\apatches\x18\x02 \x03(\v2\x12.l2smmd.FieldPatchR\apatches\"a\n" +
	...
	"\x05slice\x18\x01 \x01(\v2\r.l2smmd.SliceR\x05slice\x12\x1c\n" +
	...
	"\aoverlay\x18\x01 \x01(\v2\x0f.l2smmd.OverlayR\aoverlay\"1\n" +
	...
	"\acluster\x18\x04 \x01(\v2\x0f.l2smmd.ClusterR\acluster\".\n" +
	...
	"\rDeleteNetwork\x12\x1c.l2smmd.DeleteNetworkRequest\x1a\x1d.l2smmd.DeleteNetworkResponse\x12F\n" +
	"\vCreateSlice\x12\x1a.l2smmd.CreateSliceRequest\x1a\x1b.l2smmd.CreateSliceResponse\x12F\n" +
	"\vDeleteSlice\x12\x1a.l2smmd.DeleteSliceRequest\x1a\x1b.l2smmd.DeleteSliceResponse\x12L\n" +
	"\rCreateOverlay\x12\x1c.l2smmd.CreateOverlayRequest\x1a\x1d.l2smmd.CreateOverlayResponse\x12C\n" +
	"\n" +
	...
	"\rDeleteOverlay\x12\x1c.l2smmd.DeleteOverlayRequest\x1a\x1d.l2smmd.DeleteOverlayResponseB3Z1github.com/Networks-it-uc3m/l2sm-md/api/v1/l2smmdb\x06proto3"
